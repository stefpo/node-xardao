...
class CRUDAdapter {
    constructor (conn, table, pk) {
        ...
        this.readTableStructureAsync = promisify(this.readTableStructure)
        this.createAsync =  promisify(this.create)
        this.readAsync =  promisify(this.read)
        this.updateAsync =  promisify(this.update)
